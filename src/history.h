...
struct HistoryTables {
    static constexpr int quietHistCount = 1;
    ...
    void betaCutoff(const Board &board, const int colorToMove, const Move cutoffMove, const std::array<Move, 256> &testedMoves, const int legalMoves, const int depth) {
