...
struct Engine {
    ...
    private:
        ...
        std::array<std::array<int32_t, 2>, 32768> correctionHistoryTable;
...
constexpr int HistorySize = 16384;
constexpr int HistoryMaxBonus = 128;
constexpr int HistoryGravity = 512;
