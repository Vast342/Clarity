...
struct Engine {
    ...
    private:
        ...
        std::array<std::array<std::array<std::array<std::array<std::array<int16_t, 2>, 7>, 64>, 2>, 7>, 2> noisyHistoryTable;
        ...
        void updateNoisyHistory(const int colorToMove, const int piece, const int end, const int victim, const int bonus, const bool startAttack, const bool endAttack);
